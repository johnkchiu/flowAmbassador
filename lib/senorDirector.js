...
SenorDirector.prototype._render = function(context, flow) {
    ...
    responseModel.layout = context.layout;
    responseModel.content = context.content;
    ...
    // write flowExecutionKey + flowExecutionUrl into data
    responseModel.data.flowExecutionKey = responseModel.flow.flowExecutionKey;
    responseModel.data.flowExecutionUrl = context.url + "?execution=" + context.data.flowExecutionKey;
